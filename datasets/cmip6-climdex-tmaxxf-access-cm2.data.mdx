...
NASA Earth Exchange Global Daily Downscaled Projections (NEX-GDDP-CMIP6) [https://doi.org/10.7917/OFSG3345](https://doi.org/10.7917/OFSG3345) 
 ...
 ## Acknowledgment
Climate scenarios used as an input to this dataset were from the NEX-GDDP-CMIP6 dataset, prepared by the Climate Analytics Group and NASA Ames Research Center using the NASA Earth Exchange and distributed by the NASA Center for Climate Simulation (NCCS).
